...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <link href="https://jiaoxn.com.cn/"/>
  <updated>2019-05-30T02:37:42.095Z</updated>
  <id>https://jiaoxn.com.cn/</id>
  ...
  <entry>
    <title>ArcGIS JS API查询要素并高亮查询结果及显示PopupTemplate窗口</title>
    <link href="https://jiaoxn.com.cn/2019/05/ArcGIS%20JS%20API%E6%9F%A5%E8%AF%A2%E8%A6%81%E7%B4%A0%E5%B9%B6%E9%AB%98%E4%BA%AE%E6%9F%A5%E8%AF%A2%E7%BB%93%E6%9E%9C%E5%8F%8A%E6%98%BE%E7%A4%BAPopupTemplate%E7%AA%97%E5%8F%A3.html"/>
    <id>https://jiaoxn.com.cn/2019/05/ArcGIS JS API查询要素并高亮查询结果及显示PopupTemplate窗口.html</id>
    <published>2019-05-29T16:24:22.000Z</published>
    <updated>2019-05-30T02:37:42.095Z</updated>
    
    <content type="html"><![CDATA[<h2 id="问题描述及解决方法"><a href="#问题描述及解决方法" class="headerlink" title="问题描述及解决方法"></a>问题描述及解决方法</h2><p>在开发WebGIS系统中，有时会遇到这样的需求：</p><ul><li>基于查询条件查询要素图层，并将查询结果高亮</li><li>将查询结果缩放至当前窗口</li><li>自动弹出PopupTemplate窗口显示要素属性信息</li></ul><p>针对这样的需求，可以从以下几个方面考虑实现：</p><ul><li>对于第一个问题，首先，通过要素图层的createQuery方法构造查询语句，然后，使用要素图层的queryFeatures方法，查询满足条件的要素</li><li>对于第二个问题，可以通过调用View（MapView/SceneView）的goTo方法，缩放至查询结果</li><li>对于第三个问题，可以通过调用View的popup实例的open方法，自动弹出PopupTemplate窗口，显示要素属性信息</li></ul><p>具体提代码实现如下：</p><figure class="highlight plain"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br><span class="line">10</span><br><span class="line">11</span><br><span class="line">12</span><br><span class="line">13</span><br><span class="line">14</span><br><span class="line">15</span><br><span class="line">16</span><br><span class="line">17</span><br><span class="line">18</span><br><span class="line">19</span><br><span class="line">20</span><br><span class="line">21</span><br><span class="line">22</span><br></pre></td><td class="code"><pre><span class="line">// 获取要素图层</span><br><span class="line">let featureLayer = this.esriSceneView.map.layers.getItemAt(0);</span><br><span class="line"></span><br><span class="line">// 组织要素图层查询语句</span><br><span class="line">let queryFeatures = featureLayer.createQuery();</span><br><span class="line">queryFeatures.where = &apos;NAME=N\&apos;&apos; + featureName + &apos;\&apos;&apos;;</span><br><span class="line"></span><br><span class="line">// 查询特定的要素</span><br><span class="line">featureLayer.queryFeatures(queryFeatures).then(function (result) &#123;</span><br><span class="line">    let queryResultFeature = result.features[0];</span><br><span class="line"></span><br><span class="line">    // 缩放至当前要素</span><br><span class="line">    that.esriSceneView.goTo(queryResultFeature.geometry.extent.expand(2), &#123;</span><br><span class="line">    duration: 2000</span><br><span class="line">    &#125;).then(function () &#123;</span><br><span class="line">    // 高亮选择的要素并自动打开PopupTemple</span><br><span class="line">    that.esriSceneView.popup.open(&#123;</span><br><span class="line">        features: [queryResultFeature],</span><br><span class="line">        location: queryResultFeature.geometry.centroid</span><br><span class="line">    &#125;);</span><br><span class="line">    &#125;);</span><br><span class="line">&#125;);</span><br></pre></td></tr></table></figure><h2 id="延伸"><a href="#延伸" class="headerlink" title="延伸"></a>延伸</h2><ol><li><a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#createQuery" target="_blank" rel="noopener">createQuery</a></li></ol><p>要素服务图层的createQuery方法，可以创建一个查询对象，这个对象可以用来获取满足图层配置的要素。该方法的返回结果是<a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-tasks-support-Query.html" target="_blank" rel="noopener">Query</a>类。</p><ol start="2"><li><a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-SceneView.html#goTo" target="_blank" rel="noopener">goTo</a></li></ol><p>该方法可以将View的视角切换到指定对象，这个对象可以是：</p><ul><li>坐标对，类似于[lon, lat]</li><li>Geometry 或者 Geometry[]</li><li>Graphic 或者 Graphic[]</li><li>Viewpoint</li><li>Camera</li><li>具有target、center、scale、position、heading、tilt属性的Object对象</li></ul><p>该方法会返回一个Promise对象，当视图的视角切换到指定对象后会立马解析该Promise对象。</p><p>如果指定的对象和当前camera的位置相距甚远，倾角和航向会被自动的设置为一个中立值（朝北，从上而下），不过可以显示的设置值来避免这种行为。</p><ol start="3"><li><a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-geometry-Extent.html#expand" target="_blank" rel="noopener">expand</a></li></ol><p>根据指定因子扩展当前extend的范围。</p><ol start="4"><li><a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-SceneView.html#popup" target="_blank" rel="noopener">popup</a></li></ol><p>可以设置或获取当前view中的Popup实例，该实例能够显示图层中的常规内容或属性。可以直接修改该实例的centen或者配置图层的PopupTemplate修改popup中显示的内容。</p><ol start="5"><li><a href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Popup.html#open" target="_blank" rel="noopener">popup.open</a></li></ol><p>在指定位置打开Popup窗口，其内容可以通过content明确的指定，或者通过目标要素的PopupTemplate驱动。该方法会自动将popup实例的visible属性设置为true。仅当当前视图的大小限制符合DockOptions规定或者位置属性设置为Geometry，该popup窗口才会显示。</p>]]></content>
...
&lt;li&gt;基于查询
      ...
      <category term="开发" scheme="https://jiaoxn.com.cn/categories/%E5%BC%80%E5%8F%91/"/>
    
    
      <category term="ArcGIS API For JavaScript" scheme="https://jiaoxn.com.cn/tags/ArcGIS-API-For-JavaScript/"/>
    
      <category term="要素查询" scheme="https://jiaoxn.com.cn/tags/%E8%A6%81%E7%B4%A0%E6%9F%A5%E8%AF%A2/"/>
    
  </entry>
  
  <entry>
    <title>上传并在地图中显示Shp文件</title>
    <link href="https://jiaoxn.com.cn/2019/03/%E4%B8%8A%E4%BC%A0%E5%B9%B6%E5%9C%A8%E5%9C%B0%E5%9B%BE%E4%B8%AD%E6%98%BE%E7%A4%BAShp%E6%96%87%E4%BB%B6.html"/>
    <id>https://jiaoxn.com.cn/2019/03/上传并在地图中显示Shp文件.html</id>
...
&lt;p&gt;&lt;a href=&quot;https://www.npmjs.com/package/shape
  ...
  <entry>
    ...
    <summary type="html">
      ...
      <category term="Portal" scheme="https://jiaoxn.com.cn/tags/Portal/"/>
  ...
  <entry>
    ...
    <link href="https://jiaoxn.com.cn/2019/03/%E5%9F%BA%E4%BA%8EREST%E7%9A%84%E6%96%B9%E5%BC%8F%E8%AE%BF%E9%97%AEPortal%E7%9A%84GA%E5%B7%A5%E5%85%B7.html"/>
    <id>https://jiaoxn.com.cn/2019/03/基于REST的方式访问Portal的GA工具.html</id>
  ...
  <entry>
    ...
    <summary type="html">
      ...
      <category term="本地部署" scheme="https://jiaoxn.com.cn/tags/%E6%9C%AC%E5%9C%B0%E9%83%A8%E7%BD%B2/"/>
    
      <category term="跨域" scheme="https://jiaoxn.com.cn/tags/%E8%B7%A8%E5%9F%9F/"/>
    
  </entry>
  
  <entry>
    <title>Centos单机安装Portal</title>
    <link href="https://jiaoxn.com.cn/2019/01/Centos%E5%8D%95%E6%9C%BA%E5%AE%89%E8%A3%85PortalForArcGIS.html"/>
    <id>https://jiaoxn.com.cn/2019/01/Centos单机安装PortalForArcGIS.html</id>
    ...
    <summary type="html">
      ...
      <category term="软件安装" scheme="https://jiaoxn.com.cn/categories/%E8%BD%AF%E4%BB%B6%E5%AE%89%E8%A3%85/"/>
    
    
      <category term="Portal" scheme="https://jiaoxn.com.cn/tags/Portal/"/>
    
      <category term="Centos" scheme="https://jiaoxn.com.cn/tags/Centos/"/>
    
  </entry>
  
  <entry>
    <title>年度个人工作总结模板</title>
    <link href="https://jiaoxn.com.cn/2019/01/%E4%B8%AA%E4%BA%BA%E5%B7%A5%E4%BD%9C%E6%80%BB%E7%BB%93%E6%A8%A1%E6%9D%BF.html"/>
    <id>https://jiaoxn.com.cn/2019/01/个人工作总结模板.html</id>
    ...
    <summary type="html">
      ...
      <category term="随记" scheme="https://jiaoxn.com.cn/categories/%E9%9A%8F%E8%AE%B0/"/>
    
    
      <category term="个人工作总结" scheme="https://jiaoxn.com.cn/tags/%E4%B8%AA%E4%BA%BA%E5%B7%A5%E4%BD%9C%E6%80%BB%E7%BB%93/"/>
    
  </entry>
  
  <entry>
    <title>Windows系统下定时执行Python程序</title>
    <link href="https://jiaoxn.com.cn/2018/12/Windows%E7%B3%BB%E7%BB%9F%E4%B8%8B%E5%AE%9A%E6%97%B6%E6%89%A7%E8%A1%8CPython%E7%A8%8B%E5%BA%8F.html"/>
    <id>https://jiaoxn.com.cn/2018/12/Windows系统下定时执行Python程序.html</id>
...
&lt;p&gt;以Windows Server 2016操作系统为例，介绍如何配置任
      ...
      <category term="软件操作" scheme="https://jiaoxn.com.cn/categories/%E8%BD%AF%E4%BB%B6%E6%93%8D%E4%BD%9C/"/>
    
    
      <category term="Python" scheme="https://jiaoxn.com.cn/tags/Python/"/>
    
      <category term="Windows" scheme="https://jiaoxn.com.cn/tags/Windows/"/>
    
      <category term="定时" scheme="https://jiaoxn.com.cn/tags/%E5%AE%9A%E6%97%B6/"/>
    
  </entry>
  
  <entry>
    <title>Centos使用Nginx+Supervisor离线部署Flask应用</title>
    <link href="https://jiaoxn.com.cn/2018/12/Centos%E4%BD%BF%E7%94%A8Nginx+Supervisor%E7%A6%BB%E7%BA%BF%E9%83%A8%E7%BD%B2Flask%E5%BA%94%E7%94%A8.html"/>
    <id>https://jiaoxn.com.cn/2018/12/Centos使用Nginx+Supervisor离线部署Flask应用.html</id>
    ...
    <summary type="html">
      ...
      <category term="Flask" scheme="https://jiaoxn.com.cn/tags/Flask/"/>
    
      <category term="Nginx" scheme="https://jiaoxn.com.cn/tags/Nginx/"/>
    
      <category term="Supervisor" scheme="https://jiaoxn.com.cn/tags/Supervisor/"/>
    
  </entry>
  
  <entry>
    <title>Centos离线安装Python</title>
    <link href="https://jiaoxn.com.cn/2018/12/Centos%E7%A6%BB%E7%BA%BF%E5%AE%89%E8%A3%85Python.html"/>
    <id>https://jiaoxn.com.cn/2018/12/Centos离线安装Python.html</id>
    <published>2018-12-24T16:00:00.000Z</published>
    ...
    <summary type="html">
      ...
      <category term="离线" scheme="https://jiaoxn.com.cn/tags/%E7%A6%BB%E7%BA%BF/"/>
    
  </entry>
  
  <entry>
    <title>vue-cli 3使用vue-bootstrap-datetimepicker日期插件</title>
    <link href="https://jiaoxn.com.cn/2018/11/vue-cli%203%20%E4%BD%BF%E7%94%A8vue-bootstrap-datetimepicker%E5%8A%A0%E8%BD%BD%E6%97%A5%E6%9C%9F%E6%8F%92%E4%BB%B6.html"/>
    <id>https://jiaoxn.com.cn/2018/11/vue-cli 3 使用vue-bootstrap-datetimepicker加载日期插件.html</id>
    ...
    <summary type="html">
      ...
      <category term="vue" scheme="https://jiaoxn.com.cn/tags/vue/"/>
    
      <category term="vue-cli 3" scheme="https://jiaoxn.com.cn/tags/vue-cli-3/"/>
    
      <category term="datetimepicker" scheme="https://jiaoxn.com.cn/tags/datetimepicker/"/>
    
  </entry>
  
  <entry>
    <title>ArcGIS API For JavaScript使用自定义GP服务</title>
    <link href="https://jiaoxn.com.cn/2018/10/ArcGIS%20API%20For%20JavaScript%E4%BD%BF%E7%94%A8%E8%87%AA%E5%AE%9A%E4%B9%89GP%E6%9C%8D%E5%8A%A1.html"/>
    <id>https://jiaoxn.com.cn/2018/10/ArcGIS API For JavaScript使用自定义GP服务.html</id>
...
&lt;h2 id=&quot;使用ArcMap发布自定义GP服务&quot;&gt;&lt;a href
      ...
      <category term="GP服务" scheme="https://jiaoxn.com.cn/tags/GP%E6%9C%8D%E5%8A%A1/"/>
    
  </entry>
  
  <entry>
    <title>Windows Server 2008 R2安装PostgreSQL数据库时出现的问题及解决方法</title>
    <link href="https://jiaoxn.com.cn/2018/10/WindowsServer2008R2%E5%AE%89%E8%A3%85PostgreSQL%E6%95%B0%E6%8D%AE%E5%BA%93%E5%8F%AF%E8%83%BD%E5%87%BA%E7%8E%B0%E7%9A%84%E9%97%AE%E9%A2%98%E5%8F%8A%E8%A7%A3%E5%86%B3%E6%96%B9%E6%B3%95.html"/>
    <id>https://jiaoxn.com.cn/2018/10/WindowsServer2008R2安装PostgreSQL数据库可能出现的问题及解决方法.html</id>
    <published>2018-10-12T16:00:00.000Z</published>
    ...
    <summary type="html">
      ...
      <category term="Windows Server 2008 R2" scheme="https://jiaoxn.com.cn/tags/Windows-Server-2008-R2/"/>
    
      <category term="PostgreSQL" scheme="https://jiaoxn.com.cn/tags/PostgreSQL/"/>
    
  </entry>
  
  <entry>
    <title>ArcGIS Runtime SDK for Android(100.3)访问ArcGIS Online或Portal中的Item</title>
    <link href="https://jiaoxn.com.cn/2018/10/ArcGIS%20Runtime%20SDK%20for%20Android(100.3)%E8%AE%BF%E9%97%AEArcGIS%20Online%E6%88%96Portal%E4%B8%AD%E7%9A%84Item.html"/>
    <id>https://jiaoxn.com.cn/2018/10/ArcGIS Runtime SDK for Android(100.3)访问ArcGIS Online或Portal中的Item.html</id>
    ...
    <summary type="html">
      ...
      <category term="ArcGIS Runtime SDK for Android" scheme="https://jiaoxn.com.cn/tags/ArcGIS-Runtime-SDK-for-Android/"/>
  ...
  <entry>
    ...
    <link href="https://jiaoxn.com.cn/2018/5/Portal%E8%BF%81%E7%A7%BB.html"/>
    <id>https://jiaoxn.com.cn/2018/5/Portal迁移.html</id>
...
&lt;p&gt;2、虚拟机A1的计算机全名为example1.esri.com，IP地址为192.168.1
      ...
      <category term="Portal操作" scheme="https://jiaoxn.com.cn/categories/Portal%E6%93%8D%E4%BD%9C/"/>
  ...
  <entry>
    ...
    <link href="https://jiaoxn.com.cn/2018/5/Webstorm%E9%85%8D%E7%BD%AETomcat.html"/>
    <id>https://jiaoxn.com.cn/2018/5/Webstorm配置Tomcat.html</id>
    ...
    <summary type="html">
      ...
      <category term="Webstorm" scheme="https://jiaoxn.com.cn/tags/Webstorm/"/>
    
      <category term="Tomcat" scheme="https://jiaoxn.com.cn/tags/Tomcat/"/>
    
  </entry>
  
  <entry>
    <title>Portal注册APP</title>
    <link href="https://jiaoxn.com.cn/2018/5/Portal%E6%B3%A8%E5%86%8CAPP.html"/>
    <id>https://jiaoxn.com.cn/2018/5/Portal注册APP.html</id>
    <published>2018-05-14T16:00:00.000Z</published>
